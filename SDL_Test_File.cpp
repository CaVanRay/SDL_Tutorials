...
#define STEP_RATE_IN_MILLISECONDS  62
#define SNAKE_BLOCK_SIZE_IN_PIXELS 12
...
#define SNAKE_GAME_WIDTH  79U
#define SNAKE_GAME_HEIGHT 41U
#define SNAKE_MATRIX_SIZE (SNAKE_GAME_WIDTH * SNAKE_GAME_HEIGHT)

#define SNAKE_CELL_MAX_BITS 25U /* floor(log2(SNAKE_CELL_FOOD)) + 1 */
